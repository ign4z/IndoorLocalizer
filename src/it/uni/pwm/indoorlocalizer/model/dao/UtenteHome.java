...
//		try {
//			Utente result = (Utente) sessionFactory.getCurrentSession().merge(detachedInstance);
...
//		try {
//			Utente instance = (Utente) sessionFactory.getCurrentSession().get("Utente", id);
//			if (instance == null) {
...
//		try {
//			List results = sessionFactory.getCurrentSession().createCriteria("Utente").add(Example.create(instance))
//					.list();
